...
This method is mostly usefull when trying to analyze situations where single fluid particles play an important role. (\cite{lagvseul}) \\
...
A fitness functions is used every generation to evaluate the fitness of each solution in the population.
Fitness is a measure of how well a solution fits the problem.
With that in mind a iteration will typically look something like this:
\begin{enumerate}
	...
	\item {The selected solutions and modified selected solutions are added to the new generation.}
