...
\paragraph{Introduction to the code}\mbox{} \\
...
\paragraph{Voxelizing Geometry}\mbox{} \\
...
\paragraph{Implementing obstacle collision}\mbox{} \\
...
\begin{enumerate}
	...
	\item{Solid cells}
		\begin{itemize}
			\item{Cells thar are fully inside an obstacle}
