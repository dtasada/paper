...
\begin{center}
    ...
    \vspace{3cm}  % Add large space after title
...
\begin{abstract}
	...
	and Eulerian methods, ultimately focusing on an Eulerian grid-based approach
	...
	while also highlighting opportunities for future work in GPU acceleration and
	...
	algoritme-optimalisatie hebben vastgesteld, bleven deze componenten ongeïmplementeerd.
	Het project toont zowel het potentieel als de beperkingen van het combineren
...
wanted to do back in 5th year, but we didn't have the skills or the time to do it.
Now that we finally found an excuse to develop this large-scale project, we can
finally realize that idea into a full-fledged research paper.
