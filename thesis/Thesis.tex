...
the top and the bottom of a wing. Here are the integrals for the lift and drag
forces on a wing:
\[
	\begin{aligned}
		& \textit{where:} \\
...
We can discreetly approximate this integral by summing the pressure difference
over the surface of the wing:
\[
	\begin{array}{l}
		\textit{where $i$ is a triangle of the wing:} \\
